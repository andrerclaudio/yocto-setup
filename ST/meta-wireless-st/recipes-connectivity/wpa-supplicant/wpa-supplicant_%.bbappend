...
do_install:append () {
   ...
   ln -s ${systemd_unitdir}/system/wpa_supplicant-nl80211@wlan0.service ${D}${sysconfdir}/systemd/system/multi-user.target.wants/wpa_supplicant-nl80211@wlan0.service
}